...
public class NewContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.newContactSubmitButton).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Contact newContact = new Contact(nameField.getText().toString(),
                        ...
                        ((RadioButton)findViewById(deptRadioGroup.getCheckedRadioButtonId())).getText().toString(),
        ...
        avatarImageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent avatarIntent = new Intent(NewContactActivity.this, AvatarActivity.class);
